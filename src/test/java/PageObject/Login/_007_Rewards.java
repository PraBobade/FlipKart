...
public class _007_Rewards extends _00_BaseClass {


    public void ValidatingRewardsOption(){
        Log.info("Validate Rewards Option");
        ...
        Log.info("Rewards Option Work Properly");
