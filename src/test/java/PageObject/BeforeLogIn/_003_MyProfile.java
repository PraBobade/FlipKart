...
public class _003_MyProfile extends _00_BaseClass {


    public void ValidatingMyProfileButton(){
        ...
        for (WebElement element: Login) {
            if (element.getText().contains("My Profile")){
        ...
        Log.info("The My Profile Option Work Properly");
    }
}
